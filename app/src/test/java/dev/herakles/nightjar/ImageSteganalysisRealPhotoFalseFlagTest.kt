...
/**
 * Task W2-6 (spec.md gate-30 follow-up): properly measures [ImageSteganalysis]'s false-flag rate
 * on CLEAN, never-embedded real photos, per container -- the question task W2-4's n=3 sample
 * (`SturdyImageSteganalysisRealPhotoTest`) first raised ("the same flagged/clear verdict lands on
 * an unembedded copy of that photo... the run this detector finds tracks that photo's own
 * JPEG-quantization pattern") but was too small to size honestly.
 *
 * ## The full measurement (n=26, offline this session -- see architecture.md's steganalysis
 * section for the complete table and methodology)
 ...
 * architecture.md's 768x512/512x768 Kodak set) -- committed test resources stay small by using
 ...
 * rate (19.2%) is already material (task W2-6's own ">10%" bar) -- this chi-square/PoV check
 ...
 * = 0.85). `ImageStegoScreen.kt`'s honest caveat (task W2-6) is worded from this fuller picture --
