...
/**
 * Task #31. Byte-exact verification of [WavFile.encodePcm16Mono]'s RIFF/WAVE header against the
 ...
 *
 * Task #32 update: adds [WavFile.decodePcm16] coverage — both a standalone chunk-parsing check
...
class WavFileTest {
    ...
    // ---------------------------------------------------------------------
    // Task #32: decodePcm16 -- the inverse parse, standalone
    // ---------------------------------------------------------------------
    ...
    // ---------------------------------------------------------------------
    // Task #32: full AcousticCarrier.encode() -> WavFile.encodePcm16Mono() -> WavFile.decodePcm16()
    ...
    fun `decodePcm16 round-trips a full AcousticCarrier encode-decode cycle through an encoded WAV file`() {
        ...
        // 2. Wrap it in a WAV file, exactly like "save"/"share" (task #31) already do.
