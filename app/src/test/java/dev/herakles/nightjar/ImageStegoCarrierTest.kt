...
/**
 * Verification for Module 1 image LSB codec. Uses Robolectric so `Bitmap` is a real,
 ...
 *
 * Covers the two things the `CovertCarrier` contract requires of this codec:
...
class ImageStegoCarrierTest {
    ...
    // --- Round-trip losslessness, on both bundled sample images ---
