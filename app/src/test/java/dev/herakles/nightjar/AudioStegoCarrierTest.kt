 ...
 * from Android resources, matching the "pure-JVM `decode(encode(payload)) ==
...
class AudioStegoCarrierTest {
    ...
    fun spectrogramLsbV1CarrierStillDecodesByteForByteUnchanged() {
        // A firefly caught before this fix (v1, dense) must keep decoding exactly as
    ...
    // --- MFSK clipping fix: TONE_AMPLITUDE * up
    ...
    // --- MFSK click fix: owner-reported "crackle and pops in the first few
