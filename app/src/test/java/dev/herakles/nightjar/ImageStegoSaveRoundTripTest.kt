...
/**
 * Correctness bar for the save-as-PNG / share-via-MediaStore action pair added to
 ...
 * way: decode the produced PNG bytes back into a brand-new [Bitmap]
...
class ImageStegoSaveRoundTripTest {
    ...
    fun savedPngBytesRoundTripATextPayloadOnGradientCover() {
        ...
        val payload = "nightjar save-path round trip — the ravens have landed."
    ...
    // --- A CoverSource.Picked-style cover: not a bundled resource, embedded at
