...
/**
 * [IncomingRouter.routeImage] end-to-end coverage for the sturdy technique's registration (task
 * W1-1): [ImageFireflyDecoderRegistry.decoders] now contains [SturdyImageFireflyDecoder], so a
