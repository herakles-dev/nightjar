...
/**
 * gate-38 (v6 addition, closes deferred follow-up #12). [audioSpectrogramContentDescription]
...
class AudioSpectrogramContentDescriptionTest {
    ...
    fun `never claims genuine visibility beyond what the technique's own caption states`() {
        // SPECTROGRAM_LSB's caption is the one honesty-sensitive case (gate-19/26): it must keep
