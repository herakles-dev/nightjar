...
/**
 * Synthetic cover generators for [SturdyImageCarrier]'s unit tests (task W1-1) -- gradients,
...
object SturdyTestImages {
    ...
    /** A mostly-dark cover (deep-shadow stress case -- architecture.md's "deep-shadow mottling"
