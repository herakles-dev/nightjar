...
/**
 * W2-5 (design/riddle-trail.md § "Welcome + game layer", spec.md gate-40): pure-logic coverage
 * for the shelf's welcome-card/progress-constellation visibility rules and the trail's finale
