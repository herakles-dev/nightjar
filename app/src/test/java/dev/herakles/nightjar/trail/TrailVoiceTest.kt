...
/**
 * The rule: "jar voice rules hold (lowercase, no exclamation, no emoji)" -- checked against every
 * string in `strings_trail.xml` (the riddles and fallbacks the task calls out by name, plus the
 * rest of the trail's v6 copy, since all v6 copy falls under the same "all v6 copy lives in
