 ...
 * (design/riddle-trail.md § Probe surface reminder: "nothing persists an enum ordinal ... a
...
/**
 * Which shelf tile glows for [step] (design/riddle-trail.md § Step sequence's "Glows next"
 * column) -- null once the target isn't a shelf tile at all: [TrailStep.SEND] points at a
...
/** The wordmark subtitle's step-specific hint string resource (design/riddle-trail.md §
 *  Wordmark hint) -- replaces, never appends to, `JarShelfScreen.kt`'s default "hold to open
 *  workshop" line while a step is active. */
 ...
 * all, practice or otherwise). design/firefly-jar-identity.md's v6 addendum § Practice-firefly
 * labelling: the gloss is "shown beside the decoded riddle and labelled as a gloss" -- ordinary
 * UI copy, distinct from the riddle payload text itself, which is the record's own decoded
