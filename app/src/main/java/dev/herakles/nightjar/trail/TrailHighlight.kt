 ...
 * real firefly/record id, since exactly one target glows at a time (gate-38) and every one of
 ...
 *  moving one ever did (design/firefly-jar-identity.md v6 addendum, "Static under
 *  reduce-motion"). */
 ...
 * target (design/riddle-trail.md; design/firefly-jar-identity.md's v6 addendum, § Guidance-
 * highlight rules; spec.md gate-38, gate-36's "one next step glows at a time"). A pure no-op
 ...
 * announcement. Closes gate-38's "every highlight ... has TalkBack descriptions" without
 ...
 *
 * Stopping the glow the instant the target is tapped (gate-38's "stops on tap, not faded out") is
