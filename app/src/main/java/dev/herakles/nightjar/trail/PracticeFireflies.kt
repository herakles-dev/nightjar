 ...
 * `filesDir/practice/` -- design/riddle-trail.md's "a real carrier ... produced once by the
 ...
 * screen already offers -- NOT `FireflyRecord` rows. A row only exists once the trail's UI (W2-3)
...
object PracticeFireflies {
     ...
     *  capacity against (457 bytes at default strength), per design/riddle-trail.md § Step 2's
     ...
     * trail again" (design/riddle-trail.md: "re-seeds one fresh practice firefly per creating
     * jar").
     */
    ...
    /** Where [jar]'s practice carrier lives on disk -- W2-3 loads this as that jar's working
     *  carrier for the duration of its trail step. May not exist yet if [generate] hasn't run
