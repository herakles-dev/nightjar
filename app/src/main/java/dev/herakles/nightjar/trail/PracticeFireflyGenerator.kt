...
/**
 * Generation core for the three practice fireflies ("generated at runtime ... by the production
 * encoders"). Takes riddle text and already-decoded
 ...
 *
 * Every function below takes riddle text IN and returns carrier data (a stego [Bitmap],
...
internal object PracticeFireflyGenerator {
     ...
     *  carrier. The art carrier has no fallback (its cover's capacity is
     ...
     * architecture-wide 1024-byte ceiling).
     */
