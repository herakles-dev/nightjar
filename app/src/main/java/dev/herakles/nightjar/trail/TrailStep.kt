...
enum class TrailStep(val id: String) {
    ...
    /**
     * design/riddle-trail.md § Step 5 (owner-revised 2026-09-22, commit 6b9cedf, "§ Welcome +
     * game layer"): this step now teaches CREATING one of your own, not re-sending the art jar's
     * practice firefly. Wired by task W2-2:
