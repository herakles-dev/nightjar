...
/**
 * W2-5 (design/riddle-trail.md § "Quest lines", spec.md gate-40): [step]'s one-line hint,
...
/**
 * W2-5 (design/riddle-trail.md § "Reward lines"): [step]'s one-line celebration, shown once
 ...
 * design/firefly-jar-identity.md's "a defined success/positive-event color" allowance. Callers
