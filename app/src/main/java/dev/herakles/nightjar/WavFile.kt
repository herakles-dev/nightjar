...
/**
 * Builds a standard, self-contained RIFF/WAVE file (44-byte canonical header +
 ...
 * ```
 *
 * Adds [decodePcm16], the inverse of [encodePcm16Mono] — parses an arbitrary
...
object WavFile {
    ...
    /**
     * Result of a successful [decodePcm16]: the container's declared sample rate and
    ...
    /**
     * Parses [bytes] as a RIFF/WAVE PCM16 file — the inverse of [encodePcm16Mono].
     ...
     * only ever operates on PCM16 samples. A *correct* PCM16 file at the
