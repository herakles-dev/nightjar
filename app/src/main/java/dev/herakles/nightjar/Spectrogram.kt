...
/**
 * Stage D/3 (gate-19). One time-ordered column per STFT frame; [magnitudesDb] inside each
...
/**
 * Stage D/3 (gate-19). Short-time Fourier transform producing the AUDIO carrier's "where it
 ...
 * matching architecture.md §1's Rx overlap). The final partial frame (fewer than [frameSize]
