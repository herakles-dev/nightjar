...
/**
 * The IMAGE carrier's "where it hid" visualization: renders the
 * least-significant-bit plane of a stego image so embedded regions read as structure and
 * untouched regions read as noise — the eyeball test the LSB steganography literature's
 * LSB section describes, and the honest counterpart to what the AUDIO
 * carrier's spectrogram can show for its own techniques.
 *
