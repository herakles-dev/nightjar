...
/**
 * Module 1 — image chi-square steganalysis (task #12).
 *
 ...
 * with raw-pixel LSB embedding, matching the defensive posture spec INV-4 already established
 ...
 * the empirical separation observed on task #11's two bundled sample images — see
...
class ImageSteganalysis : CovertDetector<Bitmap> {
     ...
     *
     * Set to 0.85, not 0.5, based on empirical separation observed against task #11's two bundled
