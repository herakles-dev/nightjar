 ...
 * never from a caller-supplied MIME type or filename extension (spec.md v6 receive-plumbing task:
 * "Sniffing by magic bytes, not the declared MIME"). Both a share-sheet's declared type and a
 ...
 * (INV-12's five outcomes): a lossless container that decodes nothing is
 ...
 * knows how to route (spec.md v6 gate-31/32). No Android imports at all -- takes and returns plain
