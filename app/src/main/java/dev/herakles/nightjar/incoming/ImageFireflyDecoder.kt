 ...
 * tries first. The v6 sturdy technique registers itself here by
...
/**
 * The registration point itself: the sturdy technique lands here as [SturdyImageFireflyDecoder].
 * [IncomingRouter.routeImage] reads
