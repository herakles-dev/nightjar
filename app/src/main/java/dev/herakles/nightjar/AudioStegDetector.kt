...
/**
 * Module 2's blind audio steganalysis detector.
 *
 ...
 * hidden"). Mirrors the acoustic-modem design notes' own "Detection
 ...
 *
 * **Blind posture, enforced structurally, not just by convention**: this file never
 ...
 * contract.
 *
 * **Interface binding (deviation from the typical `AudioStegDetector : CovertDetector<
 ...
 * polarity view renders can never disagree (encoder/decoder/detector drift is
...
class AudioStegDetector : CovertDetector<WavFile.ParsedWav> {
     ...
     *  ([spectrogramLsbScore]/[mfskScore] on stereo input). Never empty in
    ...
    private companion object {
        ...
        // --- Phase-inversion scoring constants ---
