...
// the doctrine allows). No Inter TTFs bundled yet; a sibling app bundles
// Inter, and it's undecided whether nightjar follows suit. Weights limited to
// 400/500/600 either way — no 300 (fragile on OLED), no 700+ (too heavy in dark mode).
