 ...
 *
 * Every value here is transcribed from architecture.md (§1 DSP constants, §2 tone plan,
...
object NightjarAcoustics {
    ...
    enum class Protocol(
        ...
        /** Robust, hardware-independent default; the gate-2 phone-to-phone demo runs here (§2). */
    ...
    /** Architect-defined max payload for the INV-3 lossless guarantee. */
    const val MAX_PAYLOAD_BYTES: Int = 1024

    /** Recommended gate-2 demo payload ceiling (short text string). */
    ...
    /** Minimum simultaneous on-grid tones over the noise floor to flag (architecture.md §9). */
