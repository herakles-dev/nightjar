 ...
 * §4.4, §4.7, §6 — "Cozy Pixel Night"). Every visual is a continuous function of
 ...
 * "The meadow tile — dropping the jar glass"; owner decision
 ...
 *  brighter rim"). Revisit once JarShelfScreen/JarDetailScreen carry real
 ...
 *  strokes rather than one flat line, per the
 ...
 *  render ("The meadow tile — dropping the jar glass"; owner
