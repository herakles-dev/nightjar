 ...
 * voice recording. (Same honesty-about-synthetic-content discipline this repo's `covert-data`
 * research lab applies to every synthetic payload/cover it generates.)
 *
