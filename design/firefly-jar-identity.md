...
### Owner decision (2026-09-22): the meadow tile

**Open field approved.** The meadow tile drops the jar glass: a grass-line horizon with a few
distant blinking fireflies (reusing `JarNightSky.kt`'s `distantBlink`), in the meadow's
existing cool, dim palette (`JarWatchingDim`, `JarTileFillDim`, `JarTileBorderWatching`).
The radar sweep goes with the jar glass; a meadow is a place you watch, not a container.
